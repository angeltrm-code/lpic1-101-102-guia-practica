...
- Carpeta de backups de trabajo (`_bak/`).
...
- Perfiles técnicos que quieren una guía modular, clara y mantenible.
- Usuarios que prefieren aprender con práctica progresiva y trazabilidad entre temas.
...
## Nota sobre backups y `.gitignore`
